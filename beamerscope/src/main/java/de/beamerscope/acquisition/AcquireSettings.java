...
public class AcquireSettings extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        // Assign Values from former activity
        BFMode = callingActivity.BFMode;
        FPMMode = callingActivity.FPMMode;
        DFMode = callingActivity.DFMode;
        DPCMode = callingActivity.DPCMode;
        MMMode = callingActivity.MMMode;
        ...
        acquireSettingsHDRCheckbox = (CheckBox) view.findViewById(R.id.acquireSettingsHDRCheckbox);
        ...
        dropdownAcqMethods.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                ...
                AcquireActivity callingActivity = (AcquireActivity) getActivity();
                callingActivity.setAcqMethod(spinnerVal);
            }
        ...
        dropdownISOVal.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                String spinnerVal= parent.getSelectedItem().toString();
                AcquireActivity callingActivity = (AcquireActivity) getActivity();
                callingActivity.setISO(spinnerVal);
            }
            public void onNothingSelected(AdapterView<?> parent) {
            }
        });
