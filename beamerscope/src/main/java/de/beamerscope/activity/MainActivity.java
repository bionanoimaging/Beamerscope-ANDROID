...
import de.beamerscope.acquisition.AcquireActivity;
import de.beamerscope.calibration.GammaCalibActivity;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGammaCalibration.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), GammaCalibActivity.class);
                startActivity(intent);
            }
        });
